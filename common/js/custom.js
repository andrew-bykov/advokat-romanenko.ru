...
$(document).ready(function(e) {
	 ...
	 /* Form validate */
        ...
        messages: {
			...
			lettersonly :"Укажите корректное имя (только из букв и пробелов)",
			maxlength:"Введите максимум 20 символов"
			},
			lastname: {required:"Укажите вашу фамилию",	
			lettersonly :"кажите корректную фамилию (только из букв и пробелов)",
			maxlength:"Введите максимум 20 символов"
			},
            email: {
                required: "Укажите email адрес",
                email: "PУкажите корректный email адрес"
            },
            phone: "Укажите телефонный номер",	
            body: {required:"Опишите вашу ситуацию" ,
			maxlength:"PВведите максимум 1000 символов"
			}
        }
